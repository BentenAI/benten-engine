...
**INTEGRATOR `a4eb43ebaa00f1460` in flight** → `phase-4-meta-core/f-full-r5-tier1` (cherry-pick drop-b `a0da02cf` + engine-b `2ad79c9c` + ms-canary-b `82ee806d` deltas onto canary `00931e74`; disjoint crates; verify per-crate NORMAL nextest = green, NOT --all-targets-clippy/--run-ignored-all). On return: confirm clean → TIER-2.
