...
const CFG = {
  ...
  canon: `## F-FULL CANON + R4.2 CORRECTIONS (spec = R0.5)
- R4.3 = the fix-round after R4.2 found 2 BLOCKER + 7 MAJOR in the R4-fixed corpus (read: \`git show phase-4-meta-core/orchestration-2026-05-26:.addl/phase-4-meta/r4-2-triage.md\`). Spec advanced to R0.5 applying Ben's rulings. FIX every non-disagreed finding regardless of severity (HARD RULE 12).
