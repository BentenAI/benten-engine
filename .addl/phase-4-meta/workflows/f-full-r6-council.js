...
const CFG = (args && args.cfg) || {
  ...
  canon: `## PROJECT CANON (inline — review agents CANNOT read gitignored .addl/CLAUDE.md; tracked docs ARE readable via: git show 011936fd:docs/...)
