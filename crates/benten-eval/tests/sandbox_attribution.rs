...
#[test]
#[ignore = "Phase 3 — sec-pre-r1-03 attribution-frame-threading body deferred per docs/future/phase-3-backlog.md §7.3.A.1 (host-fn audit-trail capture surface lands Phase 3)"]
