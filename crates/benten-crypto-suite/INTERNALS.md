...
- **G-CORE-3d (PR #1323)** — per-Node AEAD wrap moved to `benten-graph::aead_wrap`; this crate kept the per-chunk-AEAD constants + envelope shape; AAD 2-tuple shape ratified.
