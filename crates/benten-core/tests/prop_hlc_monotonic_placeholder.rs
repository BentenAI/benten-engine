...
//! prerequisite per `docs/ENGINE-SPEC.md` §Tech Stack). The placeholder
//! below pins the deferral visibly in the test tree so a future Phase-3
//! developer lands a real proptest in the same spot rather than hunting
//! through internal triage documents.
