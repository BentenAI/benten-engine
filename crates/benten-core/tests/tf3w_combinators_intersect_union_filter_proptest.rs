...
proptest! {
    ...
    #[test]
    #[ignore = "un-ignore at G-CORE-3w: intersect narrows (P-3.1)"]
    ...
    #[test]
    #[ignore = "un-ignore at G-CORE-3w: union widens (P-3.2)"]
    ...
    #[test]
    #[ignore = "un-ignore at G-CORE-3w: filter narrows (P-3.3)"]
    ...
    #[test]
    #[ignore = "un-ignore at G-CORE-3w: intersect commutativity (P-3.4)"]
    ...
    #[test]
    #[ignore = "un-ignore at G-CORE-3w: intersect associativity (P-3.5)"]
...
#[test]
#[ignore = "un-ignore at G-CORE-3w: macros byte-equal raw builder (P-4)"]
