...
//! a per-node high-water tracker. `crates/benten-engine/src/engine_sandbox.rs::describe_sandbox_node`
...
fn describe_sandbox_node_returns_real_fuel_consumed_not_unknown() {
    ...
    //   //   crates/benten-engine/src/engine_sandbox.rs::describe_sandbox_node
    //   //
