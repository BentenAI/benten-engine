...
#[test]
#[ignore = "phase-3-backlog §7.3.D — CID-rebake cohort site 2. G16-B wave-6b shipped; test body pins specific CID-rebake site contract; un-ignore at Phase-4-Foundation pre-tag sweep per docs/future/phase-4-backlog.md §4.29 (HARD RULE 12 clause-(b))."]
...
#[test]
#[ignore = "phase-3-backlog §7.3.D — CID-rebake cohort site 3. G16-B wave-6b shipped; test body pins specific CID-rebake site contract; un-ignore at Phase-4-Foundation pre-tag sweep per docs/future/phase-4-backlog.md §4.29 (HARD RULE 12 clause-(b))."]
...
#[test]
#[ignore = "phase-3-backlog §7.3.D — CID-rebake cohort site 4. G16-B wave-6b shipped; test body pins specific CID-rebake site contract; un-ignore at Phase-4-Foundation pre-tag sweep per docs/future/phase-4-backlog.md §4.29 (HARD RULE 12 clause-(b))."]
...
#[test]
#[ignore = "phase-3-backlog §7.3.D — CID-rebake cohort site 5. G16-B wave-6b shipped; test body pins specific CID-rebake site contract; un-ignore at Phase-4-Foundation pre-tag sweep per docs/future/phase-4-backlog.md §4.29 (HARD RULE 12 clause-(b))."]
...
#[test]
#[ignore = "phase-3-backlog §7.3.D — CID-rebake cohort site 6. G16-B wave-6b shipped; test body pins specific CID-rebake site contract; un-ignore at Phase-4-Foundation pre-tag sweep per docs/future/phase-4-backlog.md §4.29 (HARD RULE 12 clause-(b))."]
...
#[test]
#[ignore = "phase-3-backlog §7.3.D — CID-rebake cohort site 7. G16-B wave-6b shipped; test body pins specific CID-rebake site contract; un-ignore at Phase-4-Foundation pre-tag sweep per docs/future/phase-4-backlog.md §4.29 (HARD RULE 12 clause-(b))."]
...
#[test]
#[ignore = "phase-3-backlog §7.3.D — CID-rebake cohort site 8. G16-B wave-6b shipped; test body pins specific CID-rebake site contract; un-ignore at Phase-4-Foundation pre-tag sweep per docs/future/phase-4-backlog.md §4.29 (HARD RULE 12 clause-(b))."]
...
#[test]
#[ignore = "phase-3-backlog §7.3.D — CID-rebake cohort site 9. G16-B wave-6b shipped; test body pins specific CID-rebake site contract; un-ignore at Phase-4-Foundation pre-tag sweep per docs/future/phase-4-backlog.md §4.29 (HARD RULE 12 clause-(b))."]
