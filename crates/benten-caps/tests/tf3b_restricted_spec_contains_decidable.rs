...
#[test]
#[ignore = "un-ignore at G-CORE-3b: RestrictedSpec::contains roots-dim arm"]
...
/// label-allowlist.
#[test]
#[ignore = "un-ignore at G-CORE-3b: RestrictedSpec::contains edge-allowlist-dim arm"]
...
#[test]
#[ignore = "un-ignore at G-CORE-3b: RestrictedSpec::contains max_depth-dim arm"]
...
#[test]
#[ignore = "un-ignore at G-CORE-3b: RestrictedSpec::contains label-allowlist-dim arm"]
...
#[test]
#[ignore = "un-ignore at G-CORE-3b: RestrictedSpec::contains label-denylist-dim INVERSE arm"]
...
/// contained.
#[test]
#[ignore = "un-ignore at G-CORE-3b: RestrictedSpec::contains property-equalities-dim arm"]
...
#[test]
#[ignore = "un-ignore at G-CORE-3b: RestrictedSpec::contains AND-composition arm"]
...
#[test]
#[ignore = "un-ignore at G-CORE-3b: RestrictedSpec::contains reflexivity arm"]
...
#[test]
#[ignore = "un-ignore at G-CORE-3b: RestrictedSpec::contains transitivity arm"]
...
#[test]
#[ignore = "un-ignore at G-CORE-3b: Spike H+1.1 use-case A smoke arm"]
