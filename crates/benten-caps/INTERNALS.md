...
A plain-English deep-dive on the `benten-caps` crate. Companion to the public `lib.rs` docs; written for fresh agents coming into Phase 3.5 / 4 work. Treats *why* and *what's load-bearing* as first-class.
...
### Phase 3.5 (Track B was a §13.11 closure)
...
### Phase 4 (plugin manifests + admin UI v0 + extension architecture)
