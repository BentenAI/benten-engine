...
//! - Per-Kind constructors + cardinality validation; the AAD 9-tuple
//!   assembly → **OPAQUE bytes** handed to the crypto-suite (m-15 GNC-5; no
//!   reverse dep); the fork-tie-break (Inv-21) CRDT rule; the federation
//!   recursion-bound (Inv-20 clause-k).
//!
