...
### §4.72 benten-eval Fwd-1 allocation-hot-path + bench-coverage cluster (Phase-4-Meta perf-pass — refinement-audit #1157, `phase-4-meta-deferred`)
...
### §4.73 benten-eval SUBSCRIBE composability seam (Phase-4-Meta architectural ratification — refinement-audit #1163 / Surf-1 #875, `phase-4-meta-deferred`)
...
### §4.74 benten-eval v1-API-stabilization cross-crate naming + ErrorCode-catalog forks (Phase-4-Meta / §4.43 v1-API-stabilization sweep — refinement-audit #807 / #802 / #1042, umbrella #1150)
