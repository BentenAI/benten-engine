...
### §4.67 Capability-mutation surface organization: `EngineCapsHandle` vs `Engine`-direct asymmetry (Phase-4-Meta / §4.43 v1-API-stabilization — Qual-2 #820 / refinement-audit #1195)
...
### §4.68 ChangeBroadcast / patterned-subscriber fan-out prefilter (Phase-4-Meta — Fwd-2 #1038 / refinement-audit #1194)
