...
### §4.71 benten-errors decentralized-registry-readiness cluster — ratification-gated arch decisions (Phase-4-Meta / v1-API-stabilization — Fwd-2 #996 + #1030 + #1053, umbrella #1182)
